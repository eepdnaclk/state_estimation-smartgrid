...
% 			save('LF_V.mat','LF_V');
			...
			LF_PQ(line,:) = DSSObj.ActiveCircuit.ActiveElement.powers;
...
legend({'$\mathbf{L = 0.5L_{0}}$ using $\mathbf{Y^{abc}}$','$\mathbf{L = L_{0}}$ using $\mathbf{Y^{abc}}$','$\mathbf{L = 1.5L_{0}}$ using $\mathbf{Y^{abc}}$', '$\mathbf{L = 0.5L_{0}}$ using $\mathbf{\overline{Y}^{abc}}$','$\mathbf{L = L_{0}}$ using $\mathbf{\overline{Y}^{abc}}$','$\mathbf{L = 1.5L_{0}}$ using $\mathbf{\overline{Y}^{abc}}$'},'Location','NorthWest','Interpreter','latex','FontSize',11);															  
...
hold on;
grid on;
plot(squeeze(Im_error_avg_inf_kron(1,:,1)),squeeze(Im_error_avg_inf_kron(1,:,2)),'ro-','Linewidth',1.5);%KRON
...
plot(squeeze(Im_error_avg_inf_our(1,:,1)),squeeze(Im_error_avg_inf_our(1,:,2)),'--r*','Linewidth',1.5);%OUR
...
hold on;
grid on;
plot(squeeze(Im_error_avg_2_kron(1,:,1)),squeeze(Im_error_avg_2_kron(1,:,2)),'ro-','Linewidth',1.5);%KRON
...
plot(squeeze(Im_error_avg_2_our(1,:,1)),squeeze(Im_error_avg_2_our(1,:,2)),'--r*','Linewidth',1.5);%OUR
...
hold on;
grid on;
plot(squeeze(Vang_error_avg_inf_kron(1,:,1)),squeeze(Vang_error_avg_inf_kron(1,:,2)),'ro-','Linewidth',1.5);%KRON
...
plot(squeeze(Vang_error_avg_inf_our(1,:,1)),squeeze(Vang_error_avg_inf_our(1,:,2)),'--r*','Linewidth',1.5);%OUR
...
legend({'$\mathbf{L = 0.5L_{0}}$ using $\mathbf{Y^{abc}}$','$\mathbf{L = L_{0}}$ using $\mathbf{Y^{abc}}$','$\mathbf{L = 1.5L_{0}}$ using $\mathbf{Y^{abc}}$', '$\mathbf{L = 0.5L_{0}}$ using $\mathbf{\overline{Y}^{abc}}$','$\mathbf{L = L_{0}}$ using $\mathbf{\overline{Y}^{abc}}$','$\mathbf{L = 1.5L_{0}}$ using $\mathbf{\overline{Y}^{abc}}$'},'Location','NorthWest','Interpreter','latex','FontSize',11);															  
xlabel('Transformer Loading','FontSize',13);
ylabel('$\mathbf{|\Delta V_{\theta} |_{avg}^{\infty}/ (radians)}$','Interpreter','latex','FontSize',13);
...
hold on;
grid on;
plot(squeeze(Vang_error_avg_2_kron(1,:,1)),squeeze(Vang_error_avg_2_kron(1,:,2)),'ro-','Linewidth',1.5);%KRON
...
plot(squeeze(Vang_error_avg_2_our(1,:,1)),squeeze(Vang_error_avg_2_our(1,:,2)),'--r*','Linewidth',1.5);%our
...
hold on;
grid on;
plot(squeeze(Iang_error_avg_inf_kron(1,:,1)),squeeze(Iang_error_avg_inf_kron(1,:,2)),'ro-','Linewidth',1.5);%KRON
...
plot(squeeze(Iang_error_avg_inf_our(1,:,1)),squeeze(Iang_error_avg_inf_our(1,:,2)),'--r*','Linewidth',1.5);%OUR
...
hold on;
grid on;
plot(squeeze(Iang_error_avg_2_kron(1,:,1)),squeeze(Iang_error_avg_2_kron(1,:,2)),'ro-','Linewidth',1.5);%kron
...
plot(squeeze(Iang_error_avg_2_our(1,:,1)),squeeze(Iang_error_avg_2_our(1,:,2)),'--r*','Linewidth',1.5);%our
...
print(Fig1,'E:\Chaminda\7.State_Estimation_LotusGrove\V3_with_new_Krons\Error_with_length\With_Comparision\Results\AMVME_L.png','-dpng','-r400');
print(Fig2,'E:\Chaminda\7.State_Estimation_LotusGrove\V3_with_new_Krons\Error_with_length\With_Comparision\Results\AVME_L.png','-dpng','-r400');
print(Fig3,'E:\Chaminda\7.State_Estimation_LotusGrove\V3_with_new_Krons\Error_with_length\With_Comparision\Results\AMCME_L.png','-dpng','-r400');
print(Fig4,'E:\Chaminda\7.State_Estimation_LotusGrove\V3_with_new_Krons\Error_with_length\With_Comparision\Results\ACME_L.png','-dpng','-r400');
print(Fig5,'E:\Chaminda\7.State_Estimation_LotusGrove\V3_with_new_Krons\Error_with_length\With_Comparision\Results\AMVAE_L.png','-dpng','-r400');
print(Fig6,'E:\Chaminda\7.State_Estimation_LotusGrove\V3_with_new_Krons\Error_with_length\With_Comparision\Results\AVAE_L.png','-dpng','-r400');
print(Fig7,'E:\Chaminda\7.State_Estimation_LotusGrove\V3_with_new_Krons\Error_with_length\With_Comparision\Results\AMCAE_L.png','-dpng','-r400');
print(Fig8,'E:\Chaminda\7.State_Estimation_LotusGrove\V3_with_new_Krons\Error_with_length\With_Comparision\Results\ACAE_L.png','-dpng','-r400');
